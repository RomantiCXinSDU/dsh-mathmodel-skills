...
从 model_spec.md 提取 $...$ 符号定义，与代码目录中的变量名比对，报告无对应实现的符号。
用法: python check_symbols.py <model_spec.md> <code_dir>
"""
import sys, os, re
...
def main():
    if len(sys.argv) < 3:
        print("用法: python check_symbols.py <model_spec.md> <code_dir>"); sys.exit(2)
